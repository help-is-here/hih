export default function PromptGenerator() {
    return (
        <div className="flex w-full flex-col justify-center gap-4 rounded-lg bg-orange-200 p-4 md:px-32 md:py-12">
            <div>
            ...
            <div className="flex w-full flex-wrap justify-center gap-4 sm:gap-0">
                <input className="w-full rounded-full border border-2 border-e-0 border-gray-700 px-4 py-2 sm:w-80 sm:rounded-none sm:rounded-s-full" />
