...
export default function PrivacyPage() {
    return (
        <PageLayout>
            <div className="mx-8 flex flex-col gap-4 p-2 md:mx-24 md:p-12">
                <h1>Privacy Policy for Help is Here</h1>

                <p>
                    At Help is Here, accessible from , one of our main
                    priorities is the privacy of our visitors. This Privacy
                    Policy document contains types of information that is
                    collected and recorded by Help is Here and how we use it.
                </p>
                ...
                <p>
                    Help is Here follows a standard procedure of using log
                ...
                <p>
                    ...
                    each of the advertising partners of Help is Here.
                </p>

                <p>
                    Third-party ad servers or ad networks uses technologies like
                    cookies, JavaScript, or Web Beacons that are used in their
                    respective advertisements and links that appear on Help is
                    Here, which are sent directly to users' browser. They
                ...
                <p>
                    Note that Help is Here has no access to or control over
                ...
                <p>
                    Help is Here's Privacy Policy does not apply to other
                ...
                <p>
                    Help is Here does not knowingly collect any Personal
                ...
                <p>
                    ...
                    information that they shared and/or collect in Help is Here.
